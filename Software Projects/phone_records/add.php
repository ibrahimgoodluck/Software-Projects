...
if (isset($_POST['ADD'])) {
	...
	$query = "insert into records(route, phone_model, imei, imei2,mobile_number,zone,requirements) values('$route','$model','$imei1','$imei2','$mobile','$zone','$requirement')";
...
" class="" required>
	...
	<div class="break2">
		...
		<input type="tel" name="tel" placeholder="0624243430
" class="" required>
		<br></br>
